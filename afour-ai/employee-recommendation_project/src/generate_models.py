def generate_models():
       ...
       '''
       This code is used to generate model and datasset pickle files in output folder
       '''

       #Merging employee with designation and department dataset
       ...
       #Filling employee category depanding on their Employee ID as they are dependent
       ...
       #Removing unimportant columns from dataset
       ...
       #Merging employee data with project data
       ...
       #Cleaning important columns and grouping them depending on employee ID
       ...
       #Work on employee skills and dropping unimportant columns and merging to final dataset
       ...
       #Gropuping skills based on employeeID
       ...
       #Making dataframe by joining worktools and skills 
       ...
       #Creating similarity model using countvector and cosine similarity
       ...
       #Dumping pickle models to output folders
