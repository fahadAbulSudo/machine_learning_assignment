...
if __name__ == "__main__":
    ...
    PATH_PARSE = os.path.join(PATH_BASE,'../output/parse.pkl')
    PATH_PROCESSDF = os.path.join(PATH_BASE,'../output/processDF.pkl')
    PATH_HRDF = os.path.join(PATH_BASE,'../output/hrDF.pkl')
    PATH_CVS = os.path.join(PATH_BASE,'../input/AFour profile')
    ...
    for filename in os.listdir(directory):
        if filename.startswith('~$') or filename.startswith('$'):
            ...
            list.append(role(data))
            list.append(skills_data(data))
            list.append(response(data))
            list.append(listed_response(data))
            list.append(experience_extractor(data))
            lst.append(list)
    ...
    pickle.dump(hrDF, open(PATH_HRDF, 'wb'))
