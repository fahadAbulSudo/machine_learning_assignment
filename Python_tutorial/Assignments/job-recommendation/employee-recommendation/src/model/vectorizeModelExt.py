...
if __name__ == "__main__":
    ...
    import subprocess
    totalData = []
    '''for doc in glob.iglob(directory + "*.doc"):
    ...
    for filename in os.listdir(directory):   
        ...
        if filename.startswith('~$') or filename.startswith('$'):
          ...
          del record
            ...
            supportFormats = [".doc", ".dot", ".dotx", ".odt", ".rtf"]
            for ext in supportFormats:
    ...
    #processDF.to_excel(PATH_BASE+"/test.xlsx")
      ...
      #os.rename(my_source, my_dest)
            ...
            if os.path.exists(PATH_PROCESSDF):
              df = pickle.load(open(PATH_PROCESSDF, 'rb'))
            ...
            pickle.dump(DF, open(PATH_PROCESSDF, 'wb'))
